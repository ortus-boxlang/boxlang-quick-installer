:: BVM (BoxLang Version Manager) Installation Script
:: Description: This script installs BVM on a Windows system.
:: Author: BoxLang Team
:: Version: @build.version@
:: License: Apache License, Version 2.0

:: This is the Windows batch script to install BVM to the system.
...
:: Note: This script assumes that the PowerShell script 'install-bvm.ps1' is in the same directory as this batch file.
@REM Install BVM
@echo off
setlocal
