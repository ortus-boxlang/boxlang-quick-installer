...
- Requirements check now installs all requirements: `curl`, `jq`, `unzip`, `brew`
...
[unreleased]: https://github.com/ortus-boxlang/boxlang-quick-installer/compare/v1.16.4...HEAD
